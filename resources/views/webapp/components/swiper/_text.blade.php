        ...
        <div class="card-body">
          <div class="row">
            <div class="col-sm-12 col-md-6 col-xs-12">
                {{-- <img src="https://upload.wikimedia.org/wikipedia/commons/c/c7/Personaje_movimiento.gif" height="240px" alt=""> --}}

                <img src="https://i.pinimg.com/originals/f4/5b/d9/f45bd9afa34729cdd851db0c7fb66381.gif"  height="240px" alt="">

                {{-- <img src="http://via.placeholder.com/600x550" width="100%" alt=""> --}}
            </div>
